...
// 点击标签页后进行路由跳转
function changeTab(tab: { paneName: any }) {
...
// 添加标签页
function addTab(name: string, title: string, query: any) {
...
<template>
  <div class="w-full h-[40px] border-b border-l border-solid gvb-tabs border-b-gray-500/20 border-l-gray-500/20">
    <div class="flex items-center justify-between h-[40px] tabs-container">
      ...
      <el-button link class="mr-2" :icon="Delete" @click="removeAllTabs">
        全部删除
      </el-button>
    </div>
  </div>
