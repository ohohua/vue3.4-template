...
<template>
  <div class="flex flex-col items-center">
    <div class="upload-box">
      ...
      <ul>
        <li class="flex items-center">请上传一个excel文件，文件格式符合模板格式：<el-button type="primary" link>下载模板</el-button></li>
        <li>支持单次最大导入5000条数据</li>
        <li>导入数据设备编号相同，更新其他字段数据</li>
      </ul>
    </div>

    <Footer class="w-full ml-auto" cancel confirm @cancel="emits('close')" @confirm="handleConfirm"></Footer>
  </div>
</template>
